...
import { PlusCircle, BellCog } from "lucide-react"; // Changed icon
import Link from "next/link";
import { getAlertDefinitions } from "@/lib/actions/inventory.actions"; // Corrected action name
...
export default async function AlertDefinitionsPage() {
  const definitions = await getAlertDefinitions(); // Corrected action name
